...
RSpec.describe 'Merchant Show Page' do
  describe 'As a visitor' do
    before :each do
      ...
      @address_1 = @user_1.addresses.create!(nickname: 'Home', address: '123 Main St', city: 'Denver', state: 'CO', zip: 80218)
      @user_2 = User.create!(name: 'Megan', email: 'megan_2@example.com', password: 'securepassword')
      @address_2 = @user_2.addresses.create!(nickname: 'Home', address: '123 Main St', city: 'Denver', state: 'IA', zip: 80218)
