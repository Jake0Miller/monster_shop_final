...
RSpec.describe Order do
  ...
  describe 'instance methods' do
    before :each do
      ...
      @address = Address.create!(nickname: 'Home', user: @user, address: '123 Main St', city: 'Denver', state: 'CO', zip: 80218)
      @order_1 = Order.create!(status: "packaged", address: @address, user: @user)
      @order_2 = Order.create!(status: "pending", address: @address, user: @user)
